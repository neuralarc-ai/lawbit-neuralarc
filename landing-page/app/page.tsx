...
const features = [
  {
    ...
    description:
      "Generate compliant legal documents in minutes with our AI-powered templates and customization tools.",
  ...
  },
  {
    ...
    title: "Risk Analysis",
    description:
      "Identify potential issues in contracts before signing with our advanced AI risk assessment technology.",
  ...
  },
  {
    ...
    description:
      "Get AI-powered guidance on legal matters with our intelligent assistant that understands legal context.",
...
const benefits = [
  {
    ...
    description:
      "Reduce your legal expenses by automating repetitive tasks and process documents.",
  ...
  },
  {
    ...
    description:
      "Generate legal documents in minutes instead of hours with AI assistance.",
  ...
  },
  {
    ...
    description:
      "Our AI has been trained on millions of legal documents to identify potential risks.",
  ...
  },
  {
    ...
    description:
      "Our system keeps in sync with the latest legal requirements to ensure compliance.",
      ...
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          >
            ...
            >
              LawBit helps startups and individuals create legal documents and
              analyze agreements to identify risks instantly
            </motion.p>
            <Image
              src="/images/hero.png"
              alt="LawBit Hero"
      ...
      <section id="testimonials" className={styles.testimonials}>
        <div className={styles.container}>
          ...
          <p className={styles.testimonialText}>
            &quot;LawBit&apos;s AI-powered contract generation is a
            game-changer. It saved us countless hours of legal drafting and
            helped us create watertight agreements with confidence.&quot;
          </p>
        </div>
      </section>
        ...
        <div className={styles.container}>
          <div className={styles.productHuntContent}>
            ...
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              From Hours to Seconds: Analyze Legal Docs with LawBit&apos;s
              Cutting-Edge AI
            </motion.p>
            ...
            <div className={styles.footerLeft}>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className={styles.footerBottom}>
                  <p>
                    All rights reserved. A product by
                    <a
