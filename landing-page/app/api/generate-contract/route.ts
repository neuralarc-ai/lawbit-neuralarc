...
export async function POST(request: Request) {
    try {
        ...
        2. Use proper legal drafting formatting with clear section headings in Title Case (not all caps)
        ...
        6. Include the current date as "Date of Agreement: [Current Date]" only once at the beginning of the document
        ...
        10. Use proper legal document styling:
            - Section headings in Title Case (not all caps)
        ...
        const modelName = preference === 'Option A' ? 'gemini-2.0-flash' : 'gemini-1.5-flash';
